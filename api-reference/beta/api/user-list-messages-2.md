...
|:--------------------|:---------------------------------------------------------|
|Delegated (work or school account) | Mail.ReadBasic OR Mail.Read OR Mail.ReadWrite    |
|Delegated (personal Microsoft account) | Mail.ReadBasic OR Mail.Read OR Mail.ReadWrite    |
|Application | Mail.ReadBasic.All OR Mail.Read OR Mail.ReadWrite |
