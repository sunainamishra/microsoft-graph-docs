...
|:---------------|:--------|:----------|:------------|
|[Create team](../api/team-post.md) | [teamsAsyncOperation](teamsasyncoperation.md) | Create a team from scratch. | Delegated (user consent), application, RSC|
|[Create team from group](../api/team-put-teams.md) | [team](team.md) | Create a new team, or add a team to an existing group.|Delegated (user consent), application, RSC|
|[Get team](../api/team-get.md) | [team](team.md) | Retrieve the properties and relationships of the specified team.|Delegated (user consent), application, RSC|
|[Update team](../api/team-update.md) | [team](team.md) |Update the properties of the specified team. |Delegated (admin consent), application, RSC|
|[Delete team](/graph/api/group-delete?view=graph-rest-1.0) | None |Delete the team and its associated group. |Delegated (admin consent), application, RSC|
|[Clone team](../api/team-clone.md) | [teamsAsyncOperation](../resources/teamsasyncoperation.md) |Copy the team and its associated group. |Delegated (admin consent), application, RSC|
|[Archive team](../api/team-archive.md) | [teamsAsyncOperation](../resources/teamsasyncoperation.md) |Put the team in a read-only state. |Delegated (admin consent), application, RSC|
|[Unarchive team](../api/team-unarchive.md) | [teamsAsyncOperation](../resources/teamsasyncoperation.md) |Restore the team to a read-write state. |Delegated (admin consent), application, RSC|
|[List your teams](../api/user-list-joinedteams.md) | [team](team.md) collection | List the teams you are a member of. |Delegated(user consent), application|
|[List all teams](/graph/teams-list-all-teams) | [group](group.md) collection | List all groups that have teams. |
|[Get team photo](../api/team-get-photo.md) | Binary data | Get the photo (picture) for a team. |Delegated(user consent), application, RSC|
|[Update team photo](../api/team-update-photo.md) | None | Update the photo (picture) for a team. |Delegated (admin consent), application, RSC|
